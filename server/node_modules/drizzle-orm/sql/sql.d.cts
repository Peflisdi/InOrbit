...
export type GetDecoderResult<T> = T extends Column
	...
	: T extends // biome-ignore lint/suspicious/noExplicitAny: <explanation>
				...
				| DriverValueDecoder<infer TData, any>["mapFromDriverValue"]
		? TData
		: never;
/**
...
export declare function isDriverValueEncoder(
	value: unknown,
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
): value is DriverValueEncoder<any, any>;
// biome-ignore lint/suspicious/noExplicitAny: <explanation>
...
export declare function param<TData, TDriver>(
	value: TData,
...
export declare function placeholder<TName extends string>(
	name: TName,
): Placeholder<TName>;
