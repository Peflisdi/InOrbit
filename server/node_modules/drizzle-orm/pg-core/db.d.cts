...
> {
	...
	with(...queries: WithSubquery[]): {
		...
		selectDistinct: {
			(): PgSelectBuilder<undefined>;
			<TSelection_1 extends SelectedFields>(
				fields: TSelection_1,
			): PgSelectBuilder<TSelection_1, "db">;
		};
		selectDistinctOn: {
			(on: (PgColumn | SQLWrapper)[]): PgSelectBuilder<undefined>;
			<TSelection_2 extends SelectedFields>(
				on: (PgColumn | SQLWrapper)[],
				fields: TSelection_2,
			): PgSelectBuilder<TSelection_2, "db">;
		};
		update: <TTable extends PgTable<import("./table.ts").TableConfig>>(
			table: TTable,
		) => PgUpdateBuilder<TTable, TQueryResult>;
		insert: <TTable_1 extends PgTable<import("./table.ts").TableConfig>>(
			table: TTable_1,
		) => PgInsertBuilder<TTable_1, TQueryResult>;
		delete: <TTable_2 extends PgTable<import("./table.ts").TableConfig>>(
			table: TTable_2,
		) => PgDeleteBase<TTable_2, TQueryResult, undefined, false, never>;
	};
	/**
...
export declare const withReplicas: <
