...
import type { Param, SQL } from "../../sql/sql.cjs";
import type { Subquery } from "../../subquery.cjs";
import type {
	SelectedFieldsFlat,
	SelectedFieldsOrdered,
} from "./select.types.cjs";
...
export declare class PgInsertBuilder<
...
> {
	...
	constructor(
		...
		session: PgSession,
		dialect: PgDialect,
		withList?: Subquery<string, Record<string, unknown>>[] | undefined,
	);
...
> = PgInsertBase<
	...
	T["_"]["excludedMethods"]
>;
export type PgInsertReturningAll<
	T extends AnyPgInsert,
	TDynamic extends boolean,
> = PgInsertBase<
	T["_"]["table"],
...
> extends QueryPromise<
	...
	readonly _: {
		...
		readonly result: TReturning extends undefined
			? PgQueryResultKind<TQueryResult, never>
			: TReturning[];
	};
}
export declare class PgInsertBase<
		TTable extends PgTable,
		TQueryResult extends PgQueryResultHKT,
		TReturning extends Record<string, unknown> | undefined = undefined,
		TDynamic extends boolean = false,
		...
		SQLWrapper
{
	 ...
	 * ```
	 */
	returning(): PgInsertWithout<
		PgInsertReturningAll<this, TDynamic>,
		TDynamic,
		"returning"
	>;
