...
export declare const createJsonSchemaTransform: ({
	skipList,
}: {
...
export declare const jsonSchemaTransform: ({
	schema,
	url,
}: {
	schema: Schema;
...
export declare const serializerCompiler: FastifySerializerCompiler<
	| ZodAny
	| {
			properties: ZodAny;
	  }
